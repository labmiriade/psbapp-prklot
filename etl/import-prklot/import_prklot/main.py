        ...
        try:
            batch.put_item(
                Item={
                    ...
                    "data": {
                        "placeId": place_id,
                        "building": get_or_error(row, "Nome_struttura"),
                        ...
                        "streetName": get_or_error(row, "Indirizzo"),
                        "parkingDiskSpots": get_or_error(row, "Posti_con_disco_orario"),
                        "paidParkingSpots": get_or_error(row, "Posti_a_pagamento"),
                        "freeParkingSpots": get_or_error(row, "Posti_liberi"),
                        "disabledParkingSpots": get_or_error(row, "Posti_disabili"),
                        "parkingSpots": get_or_error(row, "Posti_totale"),
